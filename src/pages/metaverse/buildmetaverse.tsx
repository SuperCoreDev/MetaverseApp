...
import { Container, Typography, Stack, TextField, InputAdornment } from '@mui/material';
// layouts
...
export default function BuildMetaverse() {
  ...
  return (
    <>
      ...
      <Stack sx={{width:'100%' , height:'calc(100vh - 120px)' , boxShadow: '0px 6px 12px 0px #00000033',
        background: '#202324', color: 'white', fontFamily: "Neue Haas Grotesk Display Pro", padding: '32px', gap:'20px'}}>
            ...
            <div style={{display: 'flex', alignItems: 'flex-start', alignContent: 'flex-start', gap: '20px', flexWrap: 'wrap', height: 'calc(100% - 100px)', overflowY:'scroll', padding:'20px'}}>
                    {
